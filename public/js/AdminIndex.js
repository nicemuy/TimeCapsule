function refundPaging(page){
    ...
    $.get('/refundPaging/'+page,function(data){
        ...
        $('a.arrow-left').attr('onclick','refundPaging('+data.previous+')');
        $('a.arrow-right').attr('onclick','refundPaging('+data.next+')');
